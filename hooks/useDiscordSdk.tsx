/**
 * This hook is part of the Robo.js Framework
 * https://www.github.com/Wave-Play/Robo.js
 * for any questions about it join the discord: https://discord.com/invite/fASAKnJxUP
 *
 */
...
type DiscordSession = UnwrapPromise<
...
export function DiscordContextProvider(props: DiscordContextProviderProps) {
  ...
  return (
    <DiscordContext.Provider value={setupResult}>
      {children}
...
export function useDiscordSdkSetup(options?: UseDiscordSdkSetupOptions) {
  ...
  const [status, setStatus] = useState<
    "authenticating" | "error" | "loading" | "pending" | "ready"
  >("pending");
